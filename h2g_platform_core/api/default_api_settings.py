...
class ProductionConfig(Config):
    ...
    AUTH_JWT_REALM = 'H2G-Platform-Core'
...
class DevelopmentConfig(Config):
    ...
    ONTOLOGY_BASE_URL = 'http://localhost:3030/hit2gap/'
    ...
    SQLALCHEMY_DATABASE_URI = 'sqlite:///{}'.format(
        str(APPLICATION_PATH.parents[3] / 'sqlite/h2g.db'))
...
class TestingConfig(Config):
    ...
    LOGGER_LEVEL = 'DEBUG'
    ONTOLOGY_BASE_URL = 'http://localhost:3030/hit2gap_test/'
