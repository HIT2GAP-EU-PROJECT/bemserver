...
from h2g_platform_core.models import Sensor
...
class TestApiViewsSensors(TestCoreApi):
    ...
    def test_views_sensors_get_list_filter(self, init_db_data):
    ...
    @pytest.mark.parametrize(
        'init_db_data', [{'gen_sensors': True, 'gen_measures': True}], indirect=True)
